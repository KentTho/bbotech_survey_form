    ...
    <section className="dark:bg-darkmode">
      ...
      >
        <div className="max-w-37.5 px-0 mb-8 md:mb-0" data-aos="fade-right">
          ...
          <div data-aos="fade-up">
            <Link
              ...
              className="text-xl bg-primary py-3 px-8 text-white rounded-lg me-3 mb-2 border border-primary hover:bg-[#207138]"
            >
              Buy House
            </Link>
            <Link
        ...
        <div className="lg:w-auto w-full" data-aos="fade-right">
          <div className="bg-primary rounded-t-lg p-16 w-full">
            ...
            <div className="items-center justify-center mt-12">
              ...
              <input
                ...
                className="w-full h-2 bg-[#207138] rounded-lg appearance-none cursor-pointer "
              />
            </div>
          ...
          <div className="p-4 bg-[#207138] text-white text-xl rounded-b-lg">
