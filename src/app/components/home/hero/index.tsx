                  ...
                  <div className="bg-white dark:bg-darkmode rounded-b-lg rounded-tr-lg shadow-lg p-8 pb-10">
                    ...
                    <div className="mt-6 flex flex-col-reverse gap-4 md:justify-between">
                      <div className="flex flex-col md:flex-row md:gap-4 w-full">
                        <a href="#surveyAnchor" className="flex-1 py-2 md:py-4 text-center text-lg md:text-xl px-4 md:px-8 bg-primary text-white rounded-lg hover:bg-[#207138] transition duration-300 mb-2 md:mb-0 md:mr-2">
                          Bắt đầu khảo sát
                        </a>
                        <a href="#surveyAnchor" className="flex-1 py-2 md:py-4 text-center text-lg md:text-xl px-4 md:px-8 bg-skyBlue/80 dark:bg-skyBlue/80 dark:hover:bg-skyBlue dark:hover:border-primary border border-transparent text-white rounded-lg hover:bg-skyBlue transition duration-300 text-nowrap">
                          5–6 câu hỏi
                        </a>
                      </div>
                      {error && (
