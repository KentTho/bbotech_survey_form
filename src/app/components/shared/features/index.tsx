    ...
    const fetchData = async () => {
      try {
        const [resProperties, resPage] = await Promise.all([
          fetch(getDataPath("/data/propertydata.json")),
          fetch(getDataPath("/data/pagedata.json")),
        ]);
        ...
        <div className="flex lg:flex-row flex-col lg:gap-0 gap-8 justify-between">
          <div className="mb-8 md:mb-0 flex-1">
            <div className="relative" data-aos="fade-right">
              <Image
                src={getImgPath("/images/features/features_iimage.jpg")}
                alt="property"
                width={640}
                height={615}
              ...
              <div className="lg:max-w-96 max-w-37.5 absolute bottom-0 mx-auto left-0 right-0 lg:mr-3.75">
                {value.map((property) => (
                  <div
                    key={property.id}
                    className="bg-white shadow-lg rounded-t-lg overflow-hidden"
                    data-aos="fade-up"
                    data-aos-delay="100"
                  >
                    ...
                    <div className="p-4 dark:bg-[#111929]">
                      <div className="flex dark:text-gray justify-between items-center">
                        ...
                        <div className="text-xs bg-herobg dark:bg-white dark:text-[#298D43] py-4 px-8 rounded-lg font-bold">
                          {property.location}
                        </div>
                      </div>
                      <div>
